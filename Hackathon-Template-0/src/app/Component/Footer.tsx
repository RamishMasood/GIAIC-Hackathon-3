                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex items-center">
                            <input type="email" placeholder="Enter Your Email Address" className="text-decoration: underline flex-1 px-4 py-2 border-gray-300 rounded-l-md focus:outline-none focus:ring-1 focus:ring-gray-400" />
                            <button className="text-decoration: underline  text-black px-4 py-2 rounded-r-md hover:bg-gray-800 transition">Suscribe</button>
                        </div>
                    </div>
                </div>
